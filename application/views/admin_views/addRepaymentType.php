...
<html>
<head>
	<title>Add repayment type</title>
...
<div class="row col-md-12">
	...
	<div class="col-md-8 mx-auto">
		...
		<h2 class="text-center">Add Repayment Type</h2>
        ...
        <div class="card-body">
		<form method="post" action="<?php echo base_url(); ?>/LoanAdmin/addRepaymentType">
			<div class="form-group row">
			<label class="col-sm-4 form-control-label">Repayment Name</label> 
				<div class="col-sm-8">
					<input class="form-control" type="text" name="repay_name"/>
				</div>
			</div>
		<!-- <div class="form-group row">
		<label class="col-sm-4 form-control-label">Category Code</label> 
				<div class="col-sm-8">
					<input class="form-control" type="text" name="cat_code"/>
				</div>
		</div> -->
		...
		<div class="form-group row">
            ...
            <div class="col-sm-12 text-center">  
                <input name="submit_repay" type="submit" class="btn btn-success" value="Submit">
