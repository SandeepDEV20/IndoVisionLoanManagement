...
<!-- 		<div class="form-group row">
		<label class="col-sm-4 form-control-label">Loan type</label> 
				<div class="col-sm-8">
					<input class="form-control" type="text"  value="<?php echo $user->loan_type; ?>" disabled/>
				</div>
		</div> -->
		<div class="form-group row">
		...
		<label class="col-sm-4 form-control-label">Repayment Type</label> 
				<div class="col-sm-8">
					<input class="form-control" type="text"  value="<?php echo $user->repayment_type; ?>" disabled/>
				</div>
		</div> -->
