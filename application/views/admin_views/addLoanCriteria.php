...
<script type="text/javascript">
			function select()
			{
				...
				window.location.href="<?php echo base_url(); ?>/LoanAdmin/addLoanCriteria?ID="+des;
...
<div class="row col-md-12">
	...
	<div class="col-md-8 mx-auto">
		...
		<h2 class="text-center">Add designation-wise Loan Criteria </h2>
		...
		<form method="post" action="<?php echo base_url(); ?>/LoanAdmin/addLoanCriteria">
			...
			<label class="col-sm-4 form-control-label">Department</label> 
				<div class="col-sm-8">
					...
					<option id="" disabled selected hidden>---select Category---</option>
					<?php 
					//echo $rows->category;
		...
		<label class="col-sm-4 form-control-label">Max loan Amount</label> 
				<div class="col-sm-8">
					<input class="form-control" type="number" name="max_amount" required/>
				</div>
		</div> 
		<div class="form-group row">
		...
		<label class="col-sm-4 form-control-label">Fixed installments</label> 
				<div class="col-sm-8">
					<input class="form-control" type="number" name="fixed_installments" required/>
				</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
            ...
            <div class="col-sm-12 text-center">  
                <button name="submit_criteria" type="submit" class="btn btn-success" value="Submit">
                	Add <i class="fa fa-plus-square"></i></span>
                </button>
