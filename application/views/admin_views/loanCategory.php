...
<html>
<head>
	<title>Loan Category Master</title>
...
<div class="row col-md-12">
	...
	<div class="col-md-8 mx-auto">
		...
		<h2 class="text-center">Loan Category Master</h2>
        ...
        <div class="card border-white ml-auto">
			...
			<div class="card-body"> 	
					...
					<div class="col-sm-12">  
				               <a href="<?php echo base_url(); ?>/LoanAdmin/addCategoryForm" target="_blank"> <button name="submit" type="submit" class="btn btn-success">
			...
			<?php
				...
				?>	 	
						...
						<td><?php echo $user -> category; ?></td>
							...
							<td>
							<a href="<?php echo base_url(); ?>/LoanAdmin/deleteLoanCategory?id=<?php echo $user ->id ; ?>">
